const en = {
  ...
  cacheManagement: {
    ...
    deleteDownload: 'Delete incomplete download',
    pauseDownload: 'Pause Download',
    resumeDownload: 'Resume Download',
    noDownloads: 'No incomplete downloads',
    noCachedModels: 'No cached models',
    noModelCacheItems: 'No model downloads or caches',
    noVirtualEnvironments: 'No virtual environments',
    noVirtualEnvPackages: 'No packages installed directly in this virtual environment',
    loadingPackages: 'Loading package details...',
    cancelSuccess: 'Download cancelled',
    deleteDownloadSuccess: 'Incomplete download and cached files deleted',
  ...
  launchModel: {
    ...
    embed_vision: 'Vision',
    embed_video: 'Video Processing',
    embed_audio: 'Audio Processing',
    rerank_vision: 'Vision',
    rerank_video: 'Video Processing',
    rerank_audio: 'Audio Processing',
  ...
  usageStats: {
    ...
    byApiKey: 'By API key',
    apiKeys: 'Keys',
    callVolumeByModel: 'Call volume by model',
    outputTokens: 'Output tokens',
    inputTokens: 'Input',
    ttftP95: 'TTFT P95',
    avgSpeed: 'Avg speed',
    title: 'Usage Stats',
    description: 'Call volume, active users, model mix and latency, aggregated from the audit log.',
    ...
    calls: 'Calls',
    errors: 'Errors',
    empty: 'No calls in this time range',
  },
  auditCenter: {
    firstPage: 'First',
    lastPage: 'Last',
    ...
    modelPlaceholder: 'Model name or UID',
    modelName: 'Model Name',
